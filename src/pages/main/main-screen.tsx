...
export default function MainScreen({countPlaceCard} : MainScreenProps): JSX.Element {
    return (
        <div className="page page--gray page--main">
            ...
            <main className="page__main page__main--index">
                <h1 className="visually-hidden">Cities {countPlaceCard}</h1>
                <div className="tabs">
                ...
                <div className="cities">
                  ...
                  Popular
                            ...
                            <div className="cities__places-list places__list tabs__content">
                                {/* <PlaceCard /> */}
                                {Array(countPlaceCard).fill(<PlaceCard />).map((el)=>{return el;})}
